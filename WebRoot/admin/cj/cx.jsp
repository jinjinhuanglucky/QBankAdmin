...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String str3=cb.getString("select cxda from cxda where sjbh='"+sjbh+"' and member='"+member+"'"); 
...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody> 
    ...
    <%}} %>
    <tr>
      <td class="td_bg" colspan="12" height="23" align=center>请阅卷后在成绩管理页面输入简答题成绩信息！</td>
    </tr> 
  </tbody>
</table>
